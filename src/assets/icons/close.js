...
export const CloseIcon = ({ modifiers }) => (
	<IconWrapper modifiers={modifiers} viewBox="0 0 55 55">
		<path d="M49,8.5v-8H0v47h7v7h48v-46H49z M2,45.5v-43h45v6H7v37H2z M53,52.5H9v-5v-37h40h4V52.5z" />
		<path
			d="M39.485,23.015c-0.391-0.391-1.023-0.391-1.414,0L31,30.086l-7.071-7.071c-0.391-0.391-1.023-0.391-1.414,0
